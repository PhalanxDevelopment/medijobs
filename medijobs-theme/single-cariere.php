    ...
    <div id="isCompany" class="mj-container">
        <form id="form" action="#" method="post" class="mj-register_form mj-form job-form">
            ...
            <?php
                ...
                if($formId) {
                    echo do_shortcode('[hubspot type=form portal='.$portalId.' id='.$formId.']');
                }?>
        </form>
    </div>
    <div id="section_1" class="section section_1">
        <div class="mj-container">
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-10/24">
                    <p> <?php the_content(); ?></p>
                    <a href="#job-details" class="sub_section" style="margin-top:100px; margin-bottom: 100px;">
                        <?php the_field('anchor_text'); ?>
                    </a>
                </div>
            </div>
