...
<body id="body">
    ...
    <div class="mj-container">
        <form id="form" action="https://app.medijobs.ro/register/candidate" class="mj-register_form mj-form">
            ...
            <input class="mj-input" type="text" placeholder="Nume" >
            <input class="mj-input" type="email" placeholder="Email" >
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-6/24 hide-on-mobile">
                    <div class="secton_bg_image">
                        <img src="images/subject_image_1.png" alt="">
                    </div>
                </div>
            </div>
            <div class="mj-grid">
        ...
        <div class="mj-container">
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-14/24">
                    <p><a href="">Creează-ți contul</a> pe MEDIjobs și fii pregătit să primești oferte de muncă!</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-13/24">
                    ...
                    <div class="mj-image">
                        ...
                        <img src="images/companii/fresenius-medical-care-logo-vector.png" alt="">
                        <img src="images/companii/gral-logo.png" alt="">
                        <img src="images/companii/leventer logo.png" alt="">
                        <img src="images/companii/logo_sanamed_300_162_r@2x.png" alt="">
                        <img src="images/companii/YTS-Detnal View.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mj-box">
                <div class="mj-grid">
                    ...
                    <div class="grid__item width-22/24">
                        ...
                        <h1 class="headline light uppercase">Conecteaza-te cu specialisti medicali <br> mai buni, mai repede.</h1>
    ...
    <div id="section_10" class="section section_10">
        <div class="mj-container">
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-14/24">
                    <div class="quote">
                        <img src="images/presa/Forbes-Romania-Logo-Negru.png" alt="">
                        <p>
                            Dr. Wargha Enayati: „Cea mai mare platformă de recrutare medicală din România"
                        </p>
                    </div>
                    <div class="quote">
                        <img src="images/presa/logo.png" alt="">
                        <p>
