            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-6/24 hide-on-mobile">
                    <div class="secton_bg_image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/section_1_bg.png" alt="">
                    </div>
                </div>
            </div>
            <div class="mj-grid">
        ...
        <div class="mj-container">
            <div class="mj-grid">
                ...
                <div class="grid__item width-10/24">
                    ...
                    <div class="mj-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/harta_mobile.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mj-container">
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-14/24">
                    ...
                    <div class="quote">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/wallstreet.png" alt="">
                        <p>
                    ...
                    <div class="quote">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/biz.png" alt="">
                        <p>
                    ...
                    <div class="quote">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/br.png" alt="">
                        <p>
                            Noua ta carieră poate începe aici – locuri de muncă în toate domeniile, în toate județele
                        </p>
                    </div>
                    <div class="quote">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/galenus.png" alt="">
                        <p>
                            Noua ta carieră poate începe aici – locuri de muncă în toate domeniile, în toate județele
                        </p>
                    </div>
