        ...
        <div class="mj-container">
            <div class="mj-grid">
                ...
                <div class="grid__item width-13/24">
                    ...
                    <h2 class="headline biggest uppercase"><?php echo $companiesSection['title']?></h2>
                    <h3 class="headline light"><?php echo $companiesSection['text']?></h3>
                    <div class="mj-image">
        ...
        <div class="mj-container">
            <div class="mj-grid">
                ...
                <div class="grid__item width-14/24">
                    ...
                    <h2 class="headline light"><?php echo $blueBoxes['section_title']?></h2>
                </div>
            </div>
            <div class="mj-grid">
        ...
        <div class="mj-container">
            <div class="mj-grid">
                ...
                <div class="grid__item width-6/24">
                    ...
                    <h2 class="headline light"><?php echo $testimonials['title']?></h2>
                </div>
            </div>
            <div class="mj-grid">
                <div class="grid__item width-1/24"></div>
