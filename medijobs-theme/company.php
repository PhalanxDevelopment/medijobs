        ...
        <div class="mj-container">
            <div class="mj-grid">
                ...
                <div class="grid__item width-14/24">
                    ...
                    <h1 class="headline light">Prima platformă de recrutare medicală care ajută companiile să se conecteze cu specialiști medicali relevanti din România. </h1>
                </div>
                <div class="grid__item width-7/24">
                    <ul class="mj-list">
                    </ul>
        ...
        <div class="mj-container">
            ...
            <div class="mj-grid">
                ...
                <div class="grid__item width-13/24">
                    ...
                    <h1 class="headline light">Cu ce candidati te poti conecta prin platforma MEDIjobs: </h1>
    ...
    <div id="section_7" class="section section_7">
        <div class="mj-container">
            <div class="mj-grid">
                <div class="grid__item width-1/24"></div>
                <div class="grid__item width-13/24">
                    <div class="above_headline">Activeaza o campanie de recrutare &</div>
                    <h1 class="headline light">noi te conectăm cu candidați calificați cărora le poți trimite invitații de interviuri și oferte de angajare.  </h1>
        ...
        <div class="mj-container">
            <div class="mj-grid">
                ...
                <div class="grid__item width-23/24">
                    ...
                    <h1 class="headline light">Pe blogul nostru găsești cele mai noi sfaturi pentru angajări de la specialiștii în resurse umane. </h1>
                    <div class="mj-articles" style="justify-content: flex-start;">
                        <div class="mj-article">
                            ...
                            <a href="#" class="mj-article__link">Read More</a>
