  ...
  <div class="mj-container">
    <div class="mj-grid">
      ...
      <div class="grid__item width-23/24 mj-form">
        ...
        <a href="<?php the_field('recent_articles_link'); ?>" class="mj-btn mj-btn--secondary mj-btn--alt">
...
<?php } ?>
<?php if (get_field('sponsored_articles_title')) { ?>
  <div class="section section_blog">
    <div class="mj-container">
      <div class="mj-grid">
        <div class="grid__item width-1/24 hide-on-mobile"></div>
        <div class="grid__item width-23/24 mj-form">
          <h2><?php the_field('sponsored_articles_title'); ?></h2>
          <div class="mj-articles">
            <?php
            $recent_posts = wp_get_recent_posts(array(
              'numberposts' => 6, // Number of recent posts thumbnails to display
            ...
            foreach ($recent_posts as $post) : ?>
              <div class="mj-article">
                ...
                <h3 class="mj-article__title"><a href="<?php echo get_permalink($post['ID']); ?>"><?php echo $post['post_title']; ?></a></h3>
                <a href="<?php the_field('sponsor_link', $post['ID']) ?>" class="mj-article__link">
                  <?php the_field('sponsored_text', 65) ?> <img class="sponsor_logo" src="<?php the_field('sponsor_logo', $post['ID']) ?>" alt="">
                </a>
              </div>
          ...
          <?php if (get_field('sponsored_articles_link')) { ?>
            <a href="<?php the_field('sponsored_articles_link'); ?>" class="mj-btn mj-btn--secondary mj-btn--alt">
              Vedeti toate articolele
            </a>
          <?php } ?>
        </div>
  ...
  <div class="mj-container">
    <div class="mj-grid">
      ...
      <div class="grid__item width-23/24">
        ...
        ?>
        <a href="<?php the_field('most_popular_link'); ?>" class="mj-btn mj-btn--secondary mj-btn--alt">
          Vedeti toate articolele
        </a>
      </div>
    </div>
  ...
  <div class="mj-container">
    <div class="mj-grid">
      ...
      <div class="grid__item width-23/24">
        ...
        ?>
        <a href="<?php the_field('most_read_link'); ?>" class="mj-btn mj-btn--secondary mj-btn--alt">
          Vedeti toate articolele
        </a>
      </div>
    </div>
